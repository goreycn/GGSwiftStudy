...
public extension ConstraintViewDSL {
    ...
    public func sm( _ closure: ( _ make: ConstraintMaker ) -> Void ) {
        self.makeConstraints( closure )
    }
    
    public func sr( _ closure: ( _ make: ConstraintMaker ) -> Void ) {
        self.remakeConstraints( closure )
    }
    
    public func su( _ closure: ( _ make: ConstraintMaker ) -> Void ) {
...
public extension ConstraintMakerRelatable {
    ...
    // 等于父视图
    public func es( _ offset: ConstraintOffsetTarget = 0, _ file: String = #file, _ line: UInt = #line ) {
        self.equalToSuperview().offset( offset )
    }
